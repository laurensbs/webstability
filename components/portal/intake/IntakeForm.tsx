      ...
      <div className="mt-10 flex items-center justify-between">
        ...
        {stepIndex < totalSteps - 1 ? (
          ...
          <button
            ...
            className="shadow-glow inline-flex items-center gap-1.5 rounded-full bg-(--color-accent) px-5 py-2.5 text-[13px] font-medium text-white transition-colors hover:bg-(--color-accent)/90 disabled:opacity-60"
          >
            {submitting ? (
              <>
