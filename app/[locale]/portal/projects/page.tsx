        ...
        <ul className="grid gap-4 md:grid-cols-2">
          {list.map((p) => {
            ...
            return (
              <li
                key={p.id}
                className="group hover:shadow-card relative overflow-hidden rounded-lg border border-(--color-border) bg-(--color-surface) p-6 transition-all duration-300 hover:-translate-y-0.5"
              >
                <span
                  aria-hidden
